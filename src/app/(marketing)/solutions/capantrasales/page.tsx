  ...
  return (
    ...
    >
      ...
      <div className="mt-4 rounded-2xl border border-black/10 bg-black/[0.02] px-4 py-3">
        <div className="text-xs font-semibold uppercase tracking-wide text-black/45">Pricing posture</div>
        <div className="mt-1 text-sm font-semibold text-black/80">{priceHint}</div>
      </div>
...
export default function CapantraSalesPage() {
  return (
    <div className="w-full">
      <ProductHero
        variant="amberWave"
        badges={["Platform", "CapantraSales", "Demo ready"]}
        title={
          <>
            A purpose-built sales platform —
            <br className="hidden sm:block" /> designed for agents, not CRMs.
          </>
        }
        subtitle={
          <>
            CapantraSales is the execution layer of the Capantra platform, supporting field and telesales teams with
            structured daily workflows and clear visibility into activity, performance and outcomes.
          </>
        }
        note={
          <>
            Note: CapantraSales requires an active CapantraOne licence. CapantraOne is the core management console for
            suite access. CapantraSales is currently available for demos. Compliance, payroll and regulatory obligations
      ...
      <Section tone="tint" className="py-12">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
          ...
          >
            Get a tailored map <ArrowRight className="h-4 w-4" />
          </Link>
        </div>
      ...
      <Section tone="gradient" className="py-12">
        <div>
          ...
          <h2 className="mt-2 text-2xl font-semibold text-black/85">CapantraSales vs CapantraOne</h2>
          <p className="mt-3 max-w-2xl text-sm leading-relaxed text-black/60">
            CapantraSales is agent-first (field + telesales) with profitability-grade tracking. CapantraOne is the broader
            operating layer for workflows and team operations across functions.
          </p>
        </div>
        ...
        <div className="mt-8 grid gap-4 lg:grid-cols-2">
          <PriceCard
            title="CapantraSales"
            badge="Agent-first"
            priceHint="Per agent seat, with operator modules"
            ...
            cta={{ label: "Talk pricing", href: "/company/contact" }}
            featured
          />
          ...
          <PriceCard
            ...
            priceHint="Per team/ops scope, with optional seats"
        ...
        <Surface variant="soft" className="mt-6 p-6">
          <div className="text-sm font-semibold text-black/85">Recommended buying guidance</div>
          <div className="mt-2 grid gap-3 sm:grid-cols-2">
            <div className="rounded-2xl border border-black/10 bg-white/70 p-4">
              <div className="text-xs font-semibold uppercase tracking-wide text-black/45">Choose Sales when</div>
              <ul className="mt-2 space-y-2 text-sm text-black/65">
                ...
                <li>
                  <span className="mr-2 text-black/30">•</span>
                  You need structured onboarding and performance loops.
                </li>
              </ul>
            </div>
            <div className="rounded-2xl border border-black/10 bg-white/70 p-4">
              <div className="text-xs font-semibold uppercase tracking-wide text-black/45">Choose One when</div>
              <ul className="mt-2 space-y-2 text-sm text-black/65">
                <li>
                  <span className="mr-2 text-black/30">•</span>
                  You’re standardising workflows across teams and programs.
                </li>
                <li>
                  <span className="mr-2 text-black/30">•</span>
                  Your main need is operational structure and governance.
                </li>
                <li>
                  <span className="mr-2 text-black/30">•</span>
                  You’re building a multi-surface platform rollout.
                </li>
              </ul>
            </div>
          </div>
