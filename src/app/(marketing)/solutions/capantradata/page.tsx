...
export default function CapantraDataPage() {
  return (
    <div className="w-full">
              ...
              <div className="rounded-2xl border border-black/10 bg-white/70 p-4">
                ...
                <ul className="mt-2 space-y-2 text-sm text-black/65">
                  <li>
                    ...
                    CapantraOne is the required platform for workflows, forms and team controls.
                  </li>
                  <li>
                    <span className="mr-2 text-black/30">•</span>
                    Set governance and permissions at platform level before rollout.
                  </li>
                  <li>
                    <span className="mr-2 text-black/30">•</span>
                    Review Trust Center artefacts first, then confirm region and use-case requirements.
                  </li>
                </ul>
              </div>

              <div className="rounded-2xl border border-black/10 bg-white/70 p-4">
                <div className="text-xs font-semibold uppercase tracking-wide text-black/45">Add CapantraData when</div>
                <ul className="mt-2 space-y-2 text-sm text-black/65">
                  <li>
                    <span className="mr-2 text-black/30">•</span>
                    You need governed suppression and request-handling workflows.
                  </li>
                  <li>
                    <span className="mr-2 text-black/30">•</span>
                    Data handling must be explainable, auditable and procurement-friendly.
                  </li>
                  <li>
                    <span className="mr-2 text-black/30">•</span>
                    You are operating across clients, regions and programs with clear control boundaries.
                  </li>
                </ul>
              </div>
            </div>
      ...
      <Section tone="plain" className="py-12">
        <SolutionBriefingForm solution="capantradata" />
      </Section>
