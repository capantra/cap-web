...
export default function CapantraDialPage() {
  return (
    <div className="w-full">
      <ProductHero
        ...
        note={
          <>
            ...
            CapantraOne licence, includes access to CapantraSales, and includes calls. Minimum purchase is 2 agent licences plus one
            CapantraOne admin licence. CapantraDial is currently in beta testing. See the Trust Center for procurement
            artefacts.
          </>
        }
        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-relaxed text-black/60">
              ...
              multi-client operating models. Unlike standalone dialers, execution stays connected to the Capantra
              operating layer for workflows, controls and governance.
            </p>
          </div>
          <Link
            href="#briefing-form"
        ...
        <div className="mt-6 grid gap-4 lg:grid-cols-2">
          <Surface variant="outline" className="p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="text-sm font-semibold text-black/85">Operational outcomes, not just call volume</div>
                <p className="mt-2 text-sm leading-relaxed text-black/60">
                  Standardise operational execution across clients without losing visibility, coaching context, or
                  governance control.
                </p>
                <BulletList
                  items={[
          ...
          <Surface variant="outline" className="p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="text-sm font-semibold text-black/85">Commercial and procurement clarity</div>
                <p className="mt-2 text-sm leading-relaxed text-black/60">
                  Built to support oversight with transparent buying rules; obligations and compliance requirements vary
                  by jurisdiction and use case.
                </p>
                <BulletList
                  items={[
        ...
        <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
          ...
          <Surface variant="soft" className="p-6 lg:p-8">
            ...
            <div className="mt-3 grid gap-3 sm:grid-cols-2">
              ...
              <div className="rounded-2xl border border-black/10 bg-white/70 p-4">
                <div className="text-xs font-semibold uppercase tracking-wide text-black/45">Add CapantraDial when</div>
                <ul className="mt-2 space-y-2 text-sm text-black/65">
                  <li>
                    <span className="mr-2 text-black/30">•</span>
      ...
      <Section tone="gradient" className="py-12">
        ...
        <div className="mt-8 grid gap-3 lg:grid-cols-2">
          ...
          <FaqItem
            ...
            a={
              <>
                CapantraOne provides the broader operating layer (workflows, forms, team management) and is required
                for CapantraDial access. CapantraDial is an add-on solution that includes access to CapantraSales, with
                calls included. Minimum purchase is 2 agent licences
                plus one CapantraOne admin licence.
              </>
            }
          />
        </div>
      ...
      <Section tone="plain" className="py-12">
        <SolutionBriefingForm solution="capantradial" />
      </Section>
