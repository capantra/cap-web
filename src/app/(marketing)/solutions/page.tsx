...
export default function SolutionsPage() {
  return (
    <div className="w-full">
      <ProductHero
        variant="aquaWave"
        badges={["Solutions", "Platforms", "AU · UK · US"]}
        title={
          <>
        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-semibold text-black/85">
              Choose a surface. Keep one operating layer.
            </h2>
        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div className="space-y-4">
            ...
            <p className="max-w-3xl text-sm leading-relaxed text-white/80">
              Designed to support controlled operations and transparent execution
              — with governance artefacts that make procurement review easier.
            </p>
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2">
              ...
              <div className="rounded-3xl border border-white/15 bg-white/10 p-6 backdrop-blur">
                ...
                <p className="mt-2 text-sm text-white/80">
                  Designed for transparency and review-readiness across regions
                  and use cases.
                </p>
              </div>
            </div>
          ...
          <div className="rounded-3xl border border-white/15 bg-white/10 p-6 backdrop-blur">
            ...
            <p className="mt-2 text-sm text-white/80">
              Start with governance artefacts, then map product scope against
