...
export default function CapantraOnePage() {
  return (
    <div className="w-full">
      <ProductHero
        variant="neutralWave"
        badges={["Solutions", "CapantraOne", "Core operating system"]}
        title={
          <>
      ...
      {/* NEW: Packaging / Pricing guidance */}
      <Section tone="gradient" className="py-12">
        <div>
          ...
          <h2 className="mt-2 text-2xl font-semibold text-black/85">When to buy One vs Sales</h2>
          <p className="mt-3 max-w-2xl text-sm leading-relaxed text-black/60">
            CapantraOne is the broader operating layer. CapantraSales is agent-first (field + telesales) with
            profitability-grade tracking and onboarding.
          </p>
        </div>
        ...
        <Surface variant="soft" className="mt-6 p-6">
          ...
          <div className="mt-3 grid gap-3 sm:grid-cols-2">
            <div className="rounded-2xl border border-black/10 bg-white/70 p-4">
              <div className="text-xs font-semibold uppercase tracking-wide text-black/45">Pick CapantraOne if</div>
              <ul className="mt-2 space-y-2 text-sm text-black/65">
                <li>
                  <span className="mr-2 text-black/30">•</span>You’re standardising multi-team workflows.
                </li>
                <li>
                  <span className="mr-2 text-black/30">•</span>Your core need is governance + repeatable delivery.
                </li>
                <li>
                  <span className="mr-2 text-black/30">•</span>You want a platform layer that can expand cleanly.
                </li>
              </ul>
            </div>

            <div className="rounded-2xl border border-black/10 bg-white/70 p-4">
              <div className="text-xs font-semibold uppercase tracking-wide text-black/45">Pick CapantraSales if</div>
              <ul className="mt-2 space-y-2 text-sm text-black/65">
                <li>
                  <span className="mr-2 text-black/30">•</span>Your primary users are agents (field/phone).
                </li>
                <li>
                  <span className="mr-2 text-black/30">•</span>You need cost-per-outcome and profitability visibility.
                </li>
                <li>
                  <span className="mr-2 text-black/30">•</span>You want onboarding and performance loops built in.
                </li>
              </ul>
            </div>
          </div>
