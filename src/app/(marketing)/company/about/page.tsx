  ...
  return (
    <>
          ...
          right={
            <Surface variant="soft" className="p-6">
              ...
              <p className="mt-2 text-sm leading-relaxed text-black/60">
                Capantra is structured around one platform (CapantraOne) with
                add-on solutions — while sharing consistent
      ...
      <Section tone="tint" className="py-14">
        <h2 className="text-2xl font-semibold text-black/85">Platform + solutions</h2>
        <p className="mt-3 max-w-2xl text-sm leading-relaxed text-black/60">
          CapantraOne is the platform, with CapantraDial, CapantraData, and
          CapantraSales delivered as add-on solutions.
        </p>
        <ProductTiles />
      </Section>
