...
const products = [
  {
    ...
    desc: "Field sales management solution with in-depth employee and contractor insights.",
    ...
    <section className="bg-transparent">
      <div className="mx-auto max-w-7xl px-4 py-14 lg:px-6">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <h2 className="text-2xl font-semibold text-black/85">Solutions</h2>
            <p className="mt-2 max-w-2xl text-sm leading-relaxed text-black/60">
              Add-on solutions accessed through the CapantraOne platform, built for operational clarity and
            ...
            <p className="mt-2 max-w-2xl text-sm leading-relaxed text-black/55">
              Commercial and packaging details are provided during a briefing/demo.
            </p>
          </div>
          <Link
            href="/solutions"
