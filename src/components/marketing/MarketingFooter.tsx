...
const COLS: Array<{ title: string; links: Array<{ label: string; href: string }> }> = [
  ...
  },
  {
    ...
    links: [
      { label: "Master Services Agreement", href: "/legal/master-services" },
      { label: "Service Level Agreement", href: "/legal/service-level" },
      ...
      { label: "Anti-Spam & Calling Policy", href: "/compliance/anti-spam" },
      { label: "Regulatory Alignment Statement", href: "/compliance/regulatory" },
